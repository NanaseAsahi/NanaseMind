...
from model.model_NanaseMind import NanaseMindConfig, NanaseMindForCausalLM
...
def init_model(args):
    ...
    if 'model' in args.load_from:
        model = NanaseMindForCausalLM(NanaseMindConfig(
...
def main():
    parser = argparse.ArgumentParser(description="NanaseMind模型推理与对话")
